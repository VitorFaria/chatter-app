...
export type MessageFragmentFragment = { _id: string, content: string, createdAt: string, chatId: string, userId: string };
...
export type CreateMessageMutation = { createMessage: { _id: string, content: string, createdAt: string, chatId: string, userId: string } };
...
export type MessagesQuery = { messages: Array<{ _id: string, content: string, createdAt: string, chatId: string, userId: string }> };
...
export type MessageCreatedSubscription = { messageCreated: { _id: string, content: string, createdAt: string, chatId: string, userId: string } };
