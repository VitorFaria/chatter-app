...
export type ChatFragmentFragment = { _id: string, name: string, latestMessage: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } | null };

export type MessageFragmentFragment = { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } };
...
export type CreateChatMutation = { createChat: { _id: string, name: string, latestMessage: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } | null } };
...
export type CreateMessageMutation = { createMessage: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } };
...
export type ChatQuery = { chat: { _id: string, name: string, latestMessage: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } | null } };

export type ChatsQueryVariables = Exact<{ [key: string]: never; }>;


export type ChatsQuery = { chats: Array<{ _id: string, name: string, latestMessage: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } | null }> };
...
export type MessagesQuery = { messages: Array<{ _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } }> };
...
export type MessageCreatedSubscription = { messageCreated: { _id: string, content: string, createdAt: string, chatId: string, user: { _id: string, username: string, email: string } } };
